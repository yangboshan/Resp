...
typedef enum measure_day_sta
{
    ...
    //A相总畸变电压含有率越限日累计时间
    hdHarmoAVoltOverLimitZTm,
    
    //A相2次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit2Tm,
    //A相3次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit3Tm,
    //A相4次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit4Tm,
    //A相5次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit5Tm,
    //A相6次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit6Tm,
    //A相7次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit7Tm,
    //A相8次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit8Tm,
    //A相9次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit9Tm,
    //A相10次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit10Tm,
    //A相11次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit11Tm,
    //A相12次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit12Tm,
    //A相13次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit13Tm,
    //A相14次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit14Tm,
    //A相15次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit15Tm,
    //A相16次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit16Tm,
    //A相17次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit17Tm,
    //A相18次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit18Tm,
    //A相19次谐波电压含有率越限日累计时间
    hdHarmoAVoltOverLimit19Tm,
    
    
    //A相总畸变电流含有率越限日累计时间
    hdHarmoACurOverLimitZTm,
    
    //A相2次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit2Tm,
    //A相3次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit3Tm,
    //A相4次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit4Tm,
    //A相5次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit5Tm,
    //A相6次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit6Tm,
    //A相7次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit7Tm,
    //A相8次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit8Tm,
    //A相9次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit9Tm,
    //A相10次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit10Tm,
    //A相11次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit11Tm,
    //A相12次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit12Tm,
    //A相13次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit13Tm,
    //A相14次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit14Tm,
    //A相15次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit15Tm,
    //A相16次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit16Tm,
    //A相17次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit17Tm,
    //A相18次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit18Tm,
    //A相19次谐波电流含有率越限日累计时间
    hdHarmoACurOverLimit19Tm,
    
    
    
    
    //B相总畸变电压含有率越限日累计时间
    hdHarmoBVoltOverLimitZTm,
    
    //B相2次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit2Tm,
    //B相3次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit3Tm,
    //B相4次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit4Tm,
    //B相5次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit5Tm,
    //B相6次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit6Tm,
    //B相7次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit7Tm,
    //B相8次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit8Tm,
    //B相9次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit9Tm,
    //B相10次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit10Tm,
    //B相11次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit11Tm,
    //B相12次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit12Tm,
    //B相13次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit13Tm,
    //B相14次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit14Tm,
    //B相15次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit15Tm,
    //B相16次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit16Tm,
    //B相17次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit17Tm,
    //B相18次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit18Tm,
    //B相19次谐波电压含有率越限日累计时间
    hdHarmoBVoltOverLimit19Tm,
    
    
    //B相总畸变电流含有率越限日累计时间
    hdHarmoBCurOverLimitZTm,
    
    //B相2次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit2Tm,
    //B相3次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit3Tm,
    //B相4次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit4Tm,
    //B相5次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit5Tm,
    //B相6次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit6Tm,
    //B相7次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit7Tm,
    //B相8次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit8Tm,
    //B相9次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit9Tm,
    //B相10次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit10Tm,
    //B相11次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit11Tm,
    //B相12次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit12Tm,
    //B相13次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit13Tm,
    //B相14次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit14Tm,
    //B相15次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit15Tm,
    //B相16次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit16Tm,
    //B相17次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit17Tm,
    //B相18次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit18Tm,
    //B相19次谐波电流含有率越限日累计时间
    hdHarmoBCurOverLimit19Tm,
    
    
    
    //C相总畸变电压含有率越限日累计时间
    hdHarmoCVoltOverLimitZTm,
    
    //C相2次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit2Tm,
    //C相3次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit3Tm,
    //C相4次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit4Tm,
    //C相5次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit5Tm,
    //C相6次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit6Tm,
    //C相7次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit7Tm,
    //C相8次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit8Tm,
    //C相9次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit9Tm,
    //C相10次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit10Tm,
    //C相11次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit11Tm,
    //C相12次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit12Tm,
    //C相13次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit13Tm,
    //C相14次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit14Tm,
    //C相15次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit15Tm,
    //C相16次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit16Tm,
    //C相17次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit17Tm,
    //C相18次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit18Tm,
    //C相19次谐波电压含有率越限日累计时间
    hdHarmoCVoltOverLimit19Tm,
    
    
    //C相总畸变电流含有率越限日累计时间
    hdHarmoCCurOverLimitZTm,
    
    //C相2次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit2Tm,
    //C相3次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit3Tm,
    //C相4次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit4Tm,
    //C相5次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit5Tm,
    //C相6次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit6Tm,
    //C相7次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit7Tm,
    //C相8次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit8Tm,
    //C相9次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit9Tm,
    //C相10次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit10Tm,
    //C相11次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit11Tm,
    //C相12次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit12Tm,
    //C相13次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit13Tm,
    //C相14次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit14Tm,
    //C相15次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit15Tm,
    //C相16次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit16Tm,
    //C相17次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit17Tm,
    //C相18次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit18Tm,
    //C相19次谐波电流含有率越限日累计时间
    hdHarmoCCurOverLimit19Tm,
...
typedef enum measure_day_powervalue
{
    ...
    hdPosREPowerValueZ, //日正向无功总电能量
    
    hdPosREPowerValue1, //日费率1正向无功电能量
    
    hdPosREPowerValue2, //日费率2正向无功电能量
    
    hdPosREPowerValue3, //日费率3正向无功电能量
    
    hdPosREPowerValue4, //日费率4正向无功电能量
