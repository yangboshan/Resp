...
const CGFloat MJRefreshViewHeight = 48.0;
...
NSString *const MJRefreshHeaderPullToRefresh = @"下拉召测";
NSString *const MJRefreshHeaderReleaseToRefresh = @"松开立即召测";
NSString *const MJRefreshHeaderRefreshing = @"正在召测...";
