...
-(void)encodeWithCoder:(NSCoder *)coder
{
    ...
    [coder encodeBool:self.allowsUserDragging forKey:@"CPTPlotSpace.allowsUserDragging"];
}
...
-(id)initWithCoder:(NSCoder *)coder
{
    if ( (self = [super init]) ) {
        ...
        allowsUserDragging = [coder decodeBoolForKey:@"CPTPlotSpace.allowsUserDragging"];
    }
    return self;
}
