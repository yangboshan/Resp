...
@property (nonatomic, readwrite, retain) CPTGraph *relativeGraph;
...
-(void)pinchScaleWithNewXRange:(CPTPlotRange*)range forScale:(CGFloat)scale notScale:(NSString*)notScale;
