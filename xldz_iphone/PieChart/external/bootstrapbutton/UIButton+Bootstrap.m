...
-(void)blueBorderStyle {
    ...
    self.backgroundColor = [UIColor colorWithRed:33/255.0 green:33/255.0 blue:33/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:64/255.0 green:148/255.0 blue:212/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor clearColor]] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
...
-(void)okStyle {
    ...
    self.backgroundColor = [UIColor colorWithRed:0/255.0 green:153/255.0 blue:102/255.0 alpha:1];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:39/255.0 green:39/255.0 blue:39/255.0 alpha:0.7]] forState:UIControlStateDisabled];
}
...
-(void)cancelStyle {
    ...
    self.layer.cornerRadius = 4.0;
    self.layer.borderColor = [[UIColor clearColor] CGColor];
    self.backgroundColor = [UIColor colorWithRed:153/255.0 green:51/255.0 blue:51/255.0 alpha:1];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:39/255.0 green:39/255.0 blue:39/255.0 alpha:0.7]] forState:UIControlStateDisabled];
}
...
-(void)warningStyle {
    ...
    self.layer.cornerRadius = 4.0;
    self.layer.borderColor = [[UIColor clearColor] CGColor];
    self.backgroundColor = [UIColor colorWithRed:51/255.0 green:102/255.0 blue:153/255.0 alpha:1];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:235/255.0 green:235/255.0 blue:235/255.0 alpha:1]] forState:UIControlStateHighlighted];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:39/255.0 green:39/255.0 blue:39/255.0 alpha:0.7]] forState:UIControlStateDisabled];
}

-(void)customRoundStyleWithColor:(UIColor *)color {
    [self bootstrapStyle];
    self.layer.cornerRadius = self.bounds.size.height / 2;
    self.layer.borderColor = [[UIColor clearColor] CGColor];
