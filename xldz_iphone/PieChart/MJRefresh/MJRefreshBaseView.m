...
- (void)setFrame:(CGRect)frame
{
    ...
    if (w == 0 || (_arrowImage.center.y == h * 0.5 && _arrowImage.center.x == w * 0.5 - 100)) return;
    
    CGFloat statusX = 0;
    CGFloat statusY = h * 0.5 - 10;
...
{    
    ...
    if (_scrollView.isDragging || self.multiColumnView.isDragging) {
