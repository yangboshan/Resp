...
+(CPTColor *)increaseColor
{
    ...
    if ( nil == color ) {
        color = [[CPTColor alloc] initWithComponentRed:CPTFloat(204/255. ) green:CPTFloat(28/255.) blue:CPTFloat(28/255.) alpha:CPTFloat(1.0)];
    }
    return color;
}


+(CPTColor *)decreaseColor
{
    
    static CPTColor *color = nil;
    
    if ( nil == color ) {
        color = [[CPTColor alloc] initWithComponentRed:CPTFloat(18/255.) green:CPTFloat(150/255. ) blue:CPTFloat(254/255.) alpha:CPTFloat(1.0)];
    }
    return color;
}
