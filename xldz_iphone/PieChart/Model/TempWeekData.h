...
@interface TempWeekData : NSManagedObject
...
@property (nonatomic, retain) NSString * dataTimeStart;
...
@property (nonatomic, retain) NSString * dataTimeEnd;
