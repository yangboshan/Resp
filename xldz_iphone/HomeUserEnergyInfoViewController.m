//
//  HomeUserEnergyInfoViewController.m
//  XLApp
//
...
@interface HomeUserEnergyInfoViewController ()
{
    BOOL navbarHidden;
    NSArray* tpList;
}
...
@implementation HomeUserEnergyInfoViewController
...
- (void)viewDidLoad
{
    ...
    self.title = @"电能质量";
//    [self.navigationItem setNewTitle:@"电能质量"];
...
- (void)requestDataFromDevice:(NSString*)testPointId withDate:(NSDate*)theDate withUlsNo:(NSString*)ulsNo
{
    ...
    NSMutableDictionary *notificationDic = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                            [NSString stringWithFormat:@"energy-tp-list"], @"xl-name",
                                            theDate, @"time",
                                            ulsNo,@"ulsNo",
                                            nil];
    ...
    [[XLModelDataInterface testData] requestTestPointListForEnergy:notificationDic];
...
- (void)handleTheNotify:(NSNotification *)notification{
    ...
    if (![[param objectForKey:@"xl-name"] isEqualToString:@"energy-tp-list"]) {
        return;
    }
...
#warning Incomplete method implementation.
    ...
    if(tpList!=nil) return [tpList count];
    return 0;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell2 = [tableView dequeueReusableCellWithIdentifier:@"EnergyInfoCell"];
    if (cell2 == nil) {
        // Create a temporary UIViewController to instantiate the custom cell.
        UIViewController *temporaryController = [[UIViewController alloc] initWithNibName:@"energy_list_info_cell" bundle:nil];
        // Grab a pointer to the custom cell.
        cell2 = (EnergyTableViewCell *)temporaryController.view;
        // Release the temporary UIViewController.
        
    }

    EnergyTableViewCell* cell = (EnergyTableViewCell*)cell2;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TestPointEnergyDetailViewController *controller = [[TestPointEnergyDetailViewController alloc] init];
