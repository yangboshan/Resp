...
void AFND_F121(){
    ...
    //谐波次数
//    XL_UINT8 times = *(Byte*)(userdata+offset);
    offset++;
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoAVoltOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoACurOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
...
void AFND_F122(){
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoBVoltOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoBCurOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
...
void AFND_F123(){
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoCVoltOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
    ...
    for(int i = 0;i<=18;i++){
        ...
        identifier = hdHarmoCCurOverLimitZTm + i;
        memcpy(buff + outoffset, &identifier, 2);outoffset+=2;
