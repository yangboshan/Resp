//
//  HomeUserAnalysisReportViewController.m
//  XLApp
//
...
@interface HomeUserAnalysisReportViewController ()

@end

@implementation HomeUserAnalysisReportViewController
{
    BOOL navbarHidden;
}
...
- (void)viewDidLoad
{
    ...
    self.title = @"分析报告";
    [self.navigationItem setNewTitle:@"分析报告"];
