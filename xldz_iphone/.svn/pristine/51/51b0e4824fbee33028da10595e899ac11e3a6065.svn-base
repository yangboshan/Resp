...
//    if(
//       (newPosition.x+contentFrame.size.width>320)){
//        //self.alignment=CPTAlignmentRight;
//        newPosition.x=320-contentFrame.size.width;
//    }
//    
//    if(
//       (newPosition.x<content.frame.size.width/2)){
////        self.alignment=CPTAlignmentLeft;
//        newPosition.x=contentFrame.size.width/2;
//    }
