...
@property (nonatomic,assign) BOOL panGestureOn;
@end
...
//        self.leftMenuViewController.view.frame = self.menuContainerView.bounds;
//        self.leftMenuViewController.view.autoresizingMask = UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleWidth;
...
- (void)addCenterGestureRecognizers
{
    if (self.centerViewController)
    {
//        [[self.centerViewController view] addGestureRecognizer:[self longPressGestureRecognizer]];
...
//        
////    
////        CGPoint point = [gestureRecognizer locationInView:[self.centerViewController view]];
//        NSLog(@"gesture point = %f,%f",tapPoint.x,tapPoint.y);
        
//        return NO;

        if([gestureRecognizer.view isEqual:[self.centerViewController view]] && self.panGestureOn)
...
- (void) turnOffPanGesture{
    
    self.panGestureOn=NO;
    
}

- (void)turnOnPanGesture{
    self.panGestureOn=YES;
...
- (void) handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    if(self.panGestureOn==NO) return;
