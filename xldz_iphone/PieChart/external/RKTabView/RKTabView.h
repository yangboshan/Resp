...
typedef struct HorizontalEdgeInsets {
    CGFloat left, right,maxViewTabs;
} HorizontalEdgeInsets;

static inline HorizontalEdgeInsets HorizontalEdgeInsetsMake (CGFloat left, CGFloat right,CGFloat maxViewTabs) {
    HorizontalEdgeInsets insets = {left, right,maxViewTabs};
    return insets;
}
...
@property (nonatomic) NSInteger currTab;
