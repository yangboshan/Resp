             ...
             checked:(BOOL)aChecked
{
    ...
    CGRect labelFrame = CGRectMake(CGRectGetMaxX(imageViewFrame) + 5.0f, (frame.size.height - 20.0f) / 2.0f, self.frame.size.width - CGRectGetMaxX(imageViewFrame) - 5.0f, 20.0f);
    UILabel *l = [[UILabel alloc] initWithFrame:labelFrame];
    l.textAlignment = UITextAlignmentLeft;
    l.backgroundColor = [UIColor clearColor];
    l.font = [UIFont systemFontOfSize:12];
    l.textColor = [UIColor whiteColor];//RgbHex2UIColor(0x2E, 0x2E, 0x2E);
                            ...
                            checked:(BOOL)isChecked
{
    ...
    switch (s) {
        ...
        case kSSCheckBoxViewStyleMono:
            imageName = @"cb_mono_";
            break;
        case kSSCheckBoxViewStyleCircle:
            imageName = @"cb_circle_";
            break;
        default:
            return nil;
    }
