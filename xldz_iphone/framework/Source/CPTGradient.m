...
+(CPTGradient *)increaseGradient
{
    CPTGradient *newInstance = [[self alloc] init];
    
    newInstance = [newInstance addColorStop:[CPTColor increaseColor] atPosition:0.0];
    newInstance = [newInstance addColorStop:[[CPTColor alloc] initWithComponentRed:CPTFloat(255/255. ) green:CPTFloat(127/255.) blue:CPTFloat(127/255.) alpha:CPTFloat(1.0)] atPosition:0.5];
    newInstance = [newInstance addColorStop:[[CPTColor alloc] initWithComponentRed:CPTFloat(255/255. ) green:CPTFloat(127/255.) blue:CPTFloat(127/255.) alpha:CPTFloat(1.0)] atPosition:0.5];
    newInstance = [newInstance addColorStop:[CPTColor increaseColor] atPosition:1.0];
    newInstance.angle = 180.0;
    
    return newInstance;
}

+(CPTGradient *)decreaseGradient
{
    CPTGradient *newInstance = [[self alloc] init];
    
    newInstance = [newInstance addColorStop:[CPTColor decreaseColor] atPosition:0.0];
    newInstance = [newInstance addColorStop:[[CPTColor alloc] initWithComponentRed:CPTFloat(136/255. ) green:CPTFloat(202/255.) blue:CPTFloat(252/255.) alpha:CPTFloat(1.0)] atPosition:0.5];
    newInstance = [newInstance addColorStop:[[CPTColor alloc] initWithComponentRed:CPTFloat(136/255. ) green:CPTFloat(202/255.) blue:CPTFloat(252/255.) alpha:CPTFloat(1.0)] atPosition:0.5];
    newInstance = [newInstance addColorStop:[CPTColor decreaseColor] atPosition:1.0];
    newInstance.angle = 180.0;
    return newInstance;
}
